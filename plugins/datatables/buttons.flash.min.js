(function (g) {
    ...
    function C(a, b) {
        ...
        for (var e = 0,
        f = a.body.length; e < f; e++) if (c = a.body[e][b], c = null !== c && c !== q ? c.toString() : "", -1 !== c.indexOf("\n") ? (c = c.split("\n"), c.sort(function (a, b) {
    ...
    h.Client.prototype = {
        ...
        destroy: function () {
            var a = this;
            this.domElement && this.div && (g(this.div).remove(), this.div = this.domElement = null, g.each(h.clients,
            function (b, d) {
        ...
        receiveEvent: function (a, b) {
            ...
            if (this.handlers[a]) for (var c = 0,
            e = this.handlers[a].length; c < e; c++) {
    ...
    t = function (a, b) {
        ...
        a.clearText();
        for (var c = 0,
        e = d.length; c < e; c++) a.appendText(d[c])
    },
    z = function (a) {
    ...
    v = "",
    v = "undefined" === typeof k.XMLSerializer ? new 
    function () {
    ...
    j.ext.buttons.copyFlash = g.extend({},
    u, {
    ...
    j.ext.buttons.csvFlash = g.extend({},
    u, {
    ...
    j.ext.buttons.excelFlash = g.extend({},
    u, {
        ...
        action: function (a, b, d, c) {
            ...
            j = function (a) {
                ...
                d = a.length; b < d; b++) {
                    var j = w(b) + "" + k,
                    i = null;
                    if (null === a[b] || a[b] === q || "" === a[b]) if (!0 === c.createEmptyCells) a[b] = "";
                    else continue;
                    a[b] = g.trim(a[b]);
                    for (var m = 0,
                    p = B.length; m < p; m++) {
            ...
            for (var s = 0,
            r = i.body.length; s < r; s++) j(i.body[s], e);
    ...
    j.ext.buttons.pdfFlash = g.extend({},
    u, {
