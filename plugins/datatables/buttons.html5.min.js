(function (j) {
    ...
    function n(a, b, d) {
        ...
        d && (d.attr && j(c).attr(d.attr), d.children && j.each(d.children,
        function (a, b) {
            c.appendChild(b)
    ...
    function L(a, b) {
        ...
        for (var e = 0,
        g = a.body.length; e < g; e++) if (c = a.body[e][b], c = null !== c && c !== o ? c.toString() : "", -1 !== c.indexOf("\n") ? (c = c.split("\n"), c.sort(function (a, c) {
    ...
    if ("undefined" === typeof h || "undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) u = void 0;
        ...
        F = function (a, b, d) {
            ...
            c.readyState = c.INIT;
            if (M) e = (h.URL || h.webkitURL || h).createObjectURL(a),
            setTimeout(function () {
                y.href = e;
                y.download = b;
        ...
        action: function (a, b, d, c) {
            ...
            if (k.queryCommandSupported("copy")) {
                ...
                try {
                    ...
                    d.remove();
                    if (h) {
                        b.buttons.info(b.i18n("buttons.copyTitle", "复制到粘贴板"), b.i18n("buttons.copySuccess", {
                            1: "已复制一行到粘贴板",
                            _: "已复制 %d 行到粘贴板"
                        },
                        a.rows), 2E3);
    ...
    q.ext.buttons.csvHtml5 = {
        ...
        text: function (a) {
            return a.i18n("buttons.csv", "导出为CSV")
        },
        action: function (a, b, d, c) {
            this.processing(!0);
            var a = I(b, c).str,
    ...
    q.ext.buttons.excelHtml5 = {
        ...
        text: function (a) {
            return a.i18n("buttons.excel", "导出为Excel")
        },
        action: function (a, b, d, c) {
            this.processing(!0);
            var e = this,
            ...
            m = function (a) {
                ...
                d = a.length; b < d; b++) {
                    var e = x(b) + "" + q,
                    f = null;
                    if (null === a[b] || a[b] === o || "" === a[b]) if (!0 === c.createEmptyCells) a[b] = "";
                    else continue;
                    var h = a[b];
                    a[b] = j.trim(a[b]);
                    for (var k = 0,
    ...
    q.ext.buttons.pdfHtml5 = {
        ...
        text: function (a) {
            return a.i18n("buttons.pdf", "导出为PDF")
        },
        action: function (a, b, d, c) {
            this.processing(!0);
            ...
            for (var g = 0,
            h = d.body.length; g < h; g++) e.push(j.map(d.body[g],
            function (a) {
                if (null === a || a === o) a = "";
                return {
                    text: "string" === typeof a ? a : a + "",
