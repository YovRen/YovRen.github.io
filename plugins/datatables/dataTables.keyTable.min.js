...
(function (f) {
    ...
    f.extend(n.prototype, {
        ...
        _constructor: function () {
            ...
            f(b.table().body()).on("click.keyTable", "th, td",
            function (c) {
                if (!1 !== a.s.enable) {
                    var d = b.cell(this);
            ...
            f(h).on("keydown.keyTable",
            function (b) {
                a._key(b)
            });
            if (this.c.blurable) f(h).on("mousedown.keyTable",
            function (c) {
            ...
            if (this.c.editor) {
                var d = this.c.editor;
                d.on("open.keyTableMain",
                function (b, c) {
                    "inline" !== c && a.s.enable && (a.enable(!1), d.one("close.keyTable",
                    function () {
                        a.enable(!0)
                    }))
                });
                if (this.c.editOnFocus) b.on("key-focus.keyTable key-refocus.keyTable",
                function (b, c, d, e) {
                    a._editor(null, e, !0)
                });
                b.on("key.keyTable",
        ...
        _clipboard: function () {
            var a = this.s.dt,
            b = this;
            k.getSelection && (f(h).on("copy.keyTable",
            function (a) {
                var a = a.originalEvent,
                d = k.getSelection().toString(),
                e = b.s.lastFocus; !d && e && (a.clipboardData.setData("text/plain", e.cell.render(b.c.clipboardOrthogonal)), a.preventDefault())
            }), f(h).on("paste.keyTable",
            function (c) {
                ...
                f = b.c.editor,
                g;
                if (d && (!e || "body" === e.nodeName.toLowerCase())) c.preventDefault(),
                k.clipboardData && k.clipboardData.getData ? g = k.clipboardData.getData("Text") : c.clipboardData && c.clipboardData.getData && (g = c.clipboardData.getData("text/plain")),
                f ? f.inline(d.cell.index()).set(f.displayed()[0], g).submit() : (d.cell.data(g), a.draw(!1))
            }))
        },
        _columns: function () {
            var a = this.s.dt,
        ...
        _editor: function (a, b, c) {
            ...
            if (!f("div.DTE", g.node()).length && !(null !== a && (0 <= a && 9 >= a || 11 === a || 12 === a || 14 <= a && 31 >= a || 112 <= a && 123 >= a || 127 <= a && 159 >= a))) {
                ...
                var i = function () {
                    ...
                    }).one("cancelOpen.keyTable",
                    function () {
                        j.off(".keyTable")
                    }).inline(g.index())
                };
                13 === a ? (c = !0, f(h).one("keyup",
                function () {
                    i()
                })) : i()
            }
        ...
        _focus: function (a, b, c, d) {
            ...
            if (this.s.enable) {
                ...
                if (-1 !== g.length && (a < g.start || a >= g.start + g.length)) this.s.focusDraw = !0,
                ...
                function () {
                    ...
                    if (c === o || !0 === c) this._scroll(f(k), f(h.body), i, "offset"),
    ...
    l.ext.selector.cell.push(function (a, b, c) {
        ...
        if (!a || b === o) return c;
        for (var e = 0,
        f = c.length; e < f; e++) (!0 === b && a.focused(c[e]) || !1 === b && !a.focused(c[e])) && d.push(c[e]);
        return d
    });
    f(h).on("preInit.dt.dtk",
    function (a, b) {
        if ("dt" === a.namespace) {
            var c = b.oInit.keys,
            d = l.defaults.keys;
